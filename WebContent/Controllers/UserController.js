application.controller("UserController", function($scope, $http, $cookies,
	...
	$scope.getUser = function() {
		...
		$http.get(
				'http://localhost:8081/Inter_Chat_Middleware/getUserDetail/'
	...
	$scope.updateUserDetail = function(loginName) {
		...
		$http.put(
				'http://localhost:8081/Inter_Chat_Middleware/updateUserDetail/'
						+ loginName, $scope.User).then(function(response) {
